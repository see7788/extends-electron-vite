...
}, async ({ workspacePath }) => mcp.responseContentRead(await tpl2Router.request(
...
}, async (json) => mcp.responseContentRead(await tpl2Router.request("/tpl2/source", {
  method: "PUT",
...
mcp.server.registerTool("tpl2.output.filesStatus.POST", {
  ...
  inputSchema: workspacePathSchema.shape,
  annotations: { readOnlyHint: true, destructiveHint: false, idempotentHint: true, openWorldHint: false },
}, async (json) => mcp.responseContentRead(await tpl2Router.request("/tpl2/output/filesStatus", {
  method: "POST",
  headers: { "content-type": "application/json" },
  body: JSON.stringify(json),
})));
mcp.server.registerTool("tpl2.output.materialize.POST", {
  ...
  inputSchema: workspacePathSchema.shape,
  annotations: { readOnlyHint: false, destructiveHint: true, idempotentHint: true, openWorldHint: false },
}, async (json) => mcp.responseContentRead(await tpl2Router.request("/tpl2/output/materialize", {
  method: "POST",
  headers: { "content-type": "application/json" },
  body: JSON.stringify(json),
})));
mcp.server.registerTool("tpl2.output.rebase.POST", {
  ...
  inputSchema: workspacePathSchema.shape,
  annotations: { readOnlyHint: false, destructiveHint: true, idempotentHint: true, openWorldHint: false },
}, async (json) => mcp.responseContentRead(await tpl2Router.request("/tpl2/output/rebase", {
  method: "POST",
  headers: { "content-type": "application/json" },
  body: JSON.stringify(json),
})));
