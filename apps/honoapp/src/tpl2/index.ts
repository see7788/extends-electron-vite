...
const { responseContentRead, tpl2: { server: tpl2McpServer } } = store.getState().mcpActions;

tpl2McpServer.registerTool("tpl2.source.GET", {
  title: "读取 Codex 模板源码",
...
tpl2McpServer.registerTool("tpl2.source.PUT", {
  title: "更新 Codex 模板源码",
...
tpl2McpServer.registerTool("tpl2.output.filesStatus.POST", {
...
tpl2McpServer.registerTool("tpl2.output.materialize.POST", {
  title: "物化 Codex 模板",
...
tpl2McpServer.registerTool("tpl2.output.rebase.POST", {
