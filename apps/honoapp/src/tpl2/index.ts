...
import mcp from "extends-hono/createMcpServer";
...
mcp.registerTool("tpl2.source.PUT", {
  title: "更新 Codex 模板源码",
...
mcp.registerTool("tpl2.output.filesStatus.POST", {
...
mcp.registerTool("tpl2.output.materialize.POST", {
  title: "物化 Codex 模板",
...
mcp.registerTool("tpl2.output.rebase.POST", {
