import type { GlobalSource, ProjectSource, Source } from "./schema";
        ...
        },
        {
          ...
          code: {
            ...
            content: [
              ...
              "  chatActions: { messageAdd: (content: string) => void };",
              "};",
              "",
              "export default immerStateCreator<ChatStore>((set) => ({",
              "  chat: { messages: [] },",
              "  chatActions: {",
              "    messageAdd: (content) => set((store) => { store.chat.messages.push(content); }),",
              "  },",
              "}));",
            ].join("\n"),
          },
