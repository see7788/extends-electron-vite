      ...
      sections: [
        ...
        },
        {
          ...
          orderedItems: [
            ...
            "逐项检查 result 所需 data：已有真实生产者的 data 直接消费，尚未成立的 data 进入生产切片；方法、文件和技术步骤归实现载体。",
        ...
        },
        {
          ...
          items: [
            ...
            "项目数据在当前技术步骤之外仍被真实业务消费，或由 owner 持续维护状态、生命周期或不变量；只在一个实现内部临时存在、仅传给下一技术步骤、离开当前调用便无独立意义的值属于该实现的局部变量或转换形态。",
            ...
            "消费结果只有在当前场景之外被真实业务直接消费，或开始由自身持续维护状态、生命周期或不变量时，才成为新项目 data；局部派生值、展示格式、下一步骤输入和一次性组合仍属于当前消费规则。",
